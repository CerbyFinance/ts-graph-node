...
export class DeftToken__getTemporaryReferralRealAmountsBulkResultValue0Struct extends ethereum.Tuple {
  get addr(): Address {
...
export class DeftToken extends ethereum.SmartContract {
  static bind(address: Address): DeftToken {
    return new DeftToken("DeftToken", address);
  }
  ...
  getTemporaryReferralRealAmountsBulk(
    addrs: Array<Address>
  ): Array<DeftToken__getTemporaryReferralRealAmountsBulkResultValue0Struct> {
    let result = super.call(
      "getTemporaryReferralRealAmountsBulk",
    ...
    return result[0].toTupleArray<
      DeftToken__getTemporaryReferralRealAmountsBulkResultValue0Struct
    >();
  }
