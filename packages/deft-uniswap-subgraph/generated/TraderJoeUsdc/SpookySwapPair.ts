...
export class SpookySwapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class SpookySwapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SpookySwapPair extends ethereum.SmartContract {
  static bind(address: Address): SpookySwapPair {
    return new SpookySwapPair("SpookySwapPair", address);
  }
  ...
  burn(to: Address): SpookySwapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new SpookySwapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<SpookySwapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SpookySwapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): SpookySwapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new SpookySwapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<SpookySwapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SpookySwapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
