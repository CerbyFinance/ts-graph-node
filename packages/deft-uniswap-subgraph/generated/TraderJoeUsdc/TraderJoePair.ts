...
export class TraderJoePair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class TraderJoePair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class TraderJoePair extends ethereum.SmartContract {
  static bind(address: Address): TraderJoePair {
    return new TraderJoePair("TraderJoePair", address);
  }
  ...
  burn(to: Address): TraderJoePair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new TraderJoePair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<TraderJoePair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new TraderJoePair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): TraderJoePair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new TraderJoePair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<TraderJoePair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TraderJoePair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
