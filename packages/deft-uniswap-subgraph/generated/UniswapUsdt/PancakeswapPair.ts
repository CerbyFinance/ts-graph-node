...
export class PancakeswapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class PancakeswapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class PancakeswapPair extends ethereum.SmartContract {
  static bind(address: Address): PancakeswapPair {
    return new PancakeswapPair("PancakeswapPair", address);
  }
  ...
  burn(to: Address): PancakeswapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new PancakeswapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<PancakeswapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PancakeswapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): PancakeswapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new PancakeswapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<PancakeswapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PancakeswapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
