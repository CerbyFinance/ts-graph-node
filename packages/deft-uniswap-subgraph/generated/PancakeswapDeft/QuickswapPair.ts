...
export class QuickswapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class QuickswapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class QuickswapPair extends ethereum.SmartContract {
  static bind(address: Address): QuickswapPair {
    return new QuickswapPair("QuickswapPair", address);
  }
  ...
  burn(to: Address): QuickswapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new QuickswapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<QuickswapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new QuickswapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): QuickswapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new QuickswapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<QuickswapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new QuickswapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
