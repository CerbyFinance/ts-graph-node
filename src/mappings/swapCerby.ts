...
import {
  Swap as SwapEvent,
  Sync,
} from "../types/SpookySwapCerby/SpookySwapPair";
...
export function handleSync(event: Sync): void {
  ...
  cerbyInUsd.price = cerbyReserve > ZERO_BD ? usdcReserve.div(cerbyReserve) : ZERO_BD;
...
export function handleSwap(event: SwapEvent): void {
  ...
  let feedType = amount0In > ZERO_BD ? "buy" : "sell";
